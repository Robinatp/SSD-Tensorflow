...
class SSDNet(object):
    ...
    default_params = SSDParams(
        ...
        feat_layers=['ShuffleNet/Stage2/Unit3',
                     'ShuffleNet/Stage3/Unit7',
                     'ShuffleNet/Stage4/Unit3',
                     'ShuffleNet/Stage5',
                     'ShuffleNet/Stage6',
                     'ShuffleNet/Stage7'],
        feat_shapes=[(28, 28), (14, 14), (7, 7), (5, 5), (3, 3), (1, 1)],
        anchor_size_bounds=[0.15, 0.90],
        # anchor_size_bounds=[0.20, 0.90],
        anchor_sizes=[(i[0]*224/300, i[1]*224/300) for i in [(21., 45.),
                      (45., 99.),
                      (99., 153.),
                      (153., 207.),
                      (207., 261.),
        ...
        anchor_ratios=[[2, .5],
                       ...
                       [2, .5],
                       [2, .5]],
        anchor_steps=[8, 16, 34, 50, 90, 224],#[8, 16, 32, 64, 100, 300],
        anchor_offset=0.5,
...
def ssd_net(inputs,
    ...
    end_points = {}
    base_cn = (144, 200, 240, 272, 384)
    stg2_cn = tuple(i//8 for i in base_cn)         #(18, 25, 30, 34, 48)
    stg3_cn = tuple(i//2 for i in stg2_cn)          #(9, 12, 15, 17, 24)
    stg4_cn = tuple(round(i+.5)//2 for i in stg3_cn)#(5,  6,  8,  9, 12)
    
    with slim.arg_scope(shufflenet.shufflenet_arg_scope()):
        net, end_points= shufflenet.shufflenet_g3(inputs,num_classes=1)

        #print(end_points['ShuffleNet/Stage2/Unit3'])
        #print(end_points['ShuffleNet/Stage3/Unit7'])
        #print(end_points['ShuffleNet/Stage4/Unit3'])
...
ssd_net.default_image_size = 224
