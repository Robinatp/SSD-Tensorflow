...
from nets import ssd_vgg_300_my, ssd_common, np_methods
...
def pre_process():
    ...
    ssd_params = ssd_vgg_300_my.SSDNet.default_params._replace(num_classes=num_classes)
    ssd_net = ssd_vgg_300_my.SSDNet(ssd_params)
...
def main():
    ...
    img_input,image_4d,predictions,localisations,bbox_img,ssd_anchors = pre_process()
